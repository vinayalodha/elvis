...
public interface ErrorMessage {
    ...
    String NULL_SAFE_CODE = String.format("Expression is already null safe, Are you sure you need of %s annotation", NullSafe.class.getSimpleName());
    String PARSING_BUG = String.format("Unable to instrument code, for @%s. please raise a bug", NullSafe.class.getSimpleName());
